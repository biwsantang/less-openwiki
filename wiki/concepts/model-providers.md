...
- [Agent runtime](/wiki/architecture/agent-runtime.md) — how `createModel` builds and drives the selected provider.
- [Configuration](/wiki/operations/configuration.md) — operational configuration and the full env variable surface.
- [Onboarding](/wiki/workflows/onboarding.md) — the interactive setup that collects and persists provider credentials.
