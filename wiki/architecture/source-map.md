...
Related reading: [architecture overview](/wiki/architecture/overview.md),
[agent runtime](/wiki/architecture/agent-runtime.md),
[grounded claims](/wiki/concepts/grounded-claims.md), and
[connectors](/wiki/integrations/connectors.md).
